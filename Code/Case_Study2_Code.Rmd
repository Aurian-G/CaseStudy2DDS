...
#DDS Analytics is tasked with analyzing and finding factors that influence attrition (employee turnover) and monthly income. Our goal is to identify top influential factors that are correlated with attrition to help better serve our client, Frito Lay, on achieving their talent management based needs. In addition, predictive modeling and visualizations will be leveraged heavily on achieving our goals.
